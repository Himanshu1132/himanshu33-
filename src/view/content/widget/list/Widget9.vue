            ...
            <div class="font-weight-mormal font-size-sm timeline-content text-muted pl-3">
              ...
              <div class="d-flex align-items-start mt-n2">
                <template v-for="(image, i) in item.images">
                  <!--begin::Symbol-->
                  <a class="symbol symbol-35 symbol-light-success mr-2" v-bind:key="i">
                    <span class="symbol-label">
                      <img :src="image.img" class="h-75 align-self-end" :alt="image.alt" />
                    </span>
                  </a>
                  <!--end::Symbol-->
                </template>
  ...
  data() {
    return {
      list: [
        ...
        {
          time: '14:37',
          desc: `Submit initial budget - <a class="text-primary">USD 700</a>.`,
        ...
        {
          time: '21:03',
          desc: `New order placed <a class="text-primary">#XF-2356</a>.`,
